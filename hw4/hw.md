...
Подсчет Instability
------
Подсчет сделан на скрине с текущей системой

План по распиливанию системы
------
### Есть свободные люди и ресурсы
Начинем со смены коммуникации в HCB *async* (event-driven). Это самое простое, что можно сделать в текущей системе.
![services](./async.jpg)

Меням связи в Entity-service а sync на *async* (event-driven). Так нам будет проще потом распилить монолит с финансами.
